  ...
  componentWillMount() {
    ...
    axios.post(url_buy)
      .then((ResponseData) => {
        ...
        console.log("test" + ResponseData.data[0])
      }).catch((error) => {
      });
  }
    ...
    return (
      <tr>
        ...
        <td className="orderList_btn">
          <div className="btn_center_box" onClick={this.orderDetail}>
          ...
          <div className="btn_center_box" >
            <Button  variant="outline-danger" onClick={this.forReviewToCakeView}
