...
class adminRecentHistory extends Component {
    ...
    componentWillMount() {
        ...
        // 최근 등록 상품
        let url_recent_registration = "http://localhost:8080/acorn/product/newList"
        ...
        // 제작 진행 중 상품
        let url_noworder = "http://localhost:8080/acorn/product/noworder?user_id=" + localStorage.getItem("user_id");
